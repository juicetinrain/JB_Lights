<?php
// ContactUs.php - JB Lights & Sound Contact Page
$DB_HOST = 'localhost';
$DB_USER = 'root';
$DB_PASS = '';
$DB_NAME = 'jb_lights';
...
<body>
        ...
        <div class="header-container">
            ...
            <nav class="main-nav">
                <ul class="nav-list">
                    ...
                    <li><a href="reservation.php" class="nav-link">BOOK NOW</a></li>
    ...
    <section class="contact-hero">
        <div class="hero-background">
            <img src="img/contact-hero.jpg" alt="Contact JB Lights and Sounds" class="hero-image">
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <div class="sidenav-content">
            ...
            <nav class="sidenav-menu">
                ...
                <a href="ContactUs.php" class="menu-item active">
