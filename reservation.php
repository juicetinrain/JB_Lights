                    ...
                    <div class="reservation-card">
                        ...
                        <form method="POST" id="reservationForm">
                            ...
                            <div class="step-card active" id="step1">
                                ...
                                <div class="text-end">
                                    <button type="button" class="btn btn-primary btn-reservation" onclick="nextStep(1)">Next <i class="bi bi-arrow-right ms-2"></i></button>
                                </div>
                            </div>
                            ...
                            <div class="step-card" id="step2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" id="event_address" placeholder="Enter full event address..." required>
                                ...
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-secondary btn-reservation" onclick="prevStep(2)"><i class="bi bi-arrow-left me-2"></i> Back</button>
                                    <button type="button" class="btn btn-primary btn-reservation" onclick="nextStep(2)">Next <i class="bi bi-arrow-right ms-2"></i></button>
                                </div>
                            </div>
                            ...
                            <div class="step-card" id="step3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-secondary btn-reservation" onclick="prevStep(3)"><i class="bi bi-arrow-left me-2"></i> Back</button>
                                    <button type="button" class="btn btn-primary btn-reservation" onclick="nextStep(3)">Next <i class="bi bi-arrow-right ms-2"></i></button>
                                </div>
                            </div>
                            ...
                            <div class="step-card" id="step4">
                                ...
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-secondary btn-reservation" onclick="prevStep(4)"><i class="bi bi-arrow-left me-2"></i> Back</button>
                                    <button type="button" class="btn btn-primary btn-reservation" onclick="nextStep(4)">Next <i class="bi bi-arrow-right ms-2"></i></button>
                                </div>
                            </div>
                            ...
                            <div class="step-card" id="step5">
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <button type="button" class="btn btn-secondary btn-reservation" onclick="prevStep(5)"><i class="bi bi-arrow-left me-2"></i> Back</button>
                                    <button type="submit" name="submit_reservation" class="btn btn-success btn-reservation">Confirm reservation <i class="bi bi-check ms-2"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
